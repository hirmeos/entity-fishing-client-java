...
/**
 * Class copied from Grobid - to avoid bringing in grobid-core for just one class...
 *
 * Date: 11/24/11
 * Time: 11:39 AM
 *
...
public final class Language {
    ...
    public Language(String langId) {
        if (langId == null) {
            throw new RuntimeException("Language id cannot be null");
        }
        ...
        if ((langId.length() != 3 && langId.length() != 2 && (!langId.equals("sorb")) && 
            ...
            throw new RuntimeException("Language id should consist of two or three letters, but was: " + langId);
        }
